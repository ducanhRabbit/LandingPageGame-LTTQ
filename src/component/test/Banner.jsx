...
function Banner() {
    ...
    return (
        <>
                ...
                <div style={{
                    ...
                    <section className=' relative overflow-hidden'>
                        <div className='navigation absolute  top-[320px] left-[90px] flex flex-col gap-12'>
                            <div className='w-full h-[2px] left-[19px] absolute -z-10 border-dotted border-white opacity-90 border-t-4 origin-left rotate-90 -top-[16px]'></div>
                            <a className='cursor-pointer'>
                                <div className='flex items-center gap-4'>
                                    <div>
                                        <img src='./src/assets/img/navigate-active.png'/>
                                    </div>
                                    <span className='stroke-text-active text-3xl font-semibold'>Trang Chủ</span>
                                </div>
                            </a>
                            <a className='cursor-pointer'>
                                <div className='flex items-center gap-4'>
                                    <div>
                                        <img src='./src/assets/img/navigate-unactive.png'/>
                                    </div>
            ...
            <div className='fixed w-full float hidden top-0'>
                <div className='float-content'>
                    <a className='inline-block w-[150px] absolute right-16 top-[350px]' href=''>
