    ...
    <div className='relative'>
      <div >
        <div className='anchor w-[312px]  md:w-[574px] md:h-[588px] absolute left-1/2 -translate-x-[calc(50%_+_20px)] md:-translate-x-1/2'>
          <div className='100.000 w-[312px] md:w-[574px] bg-cover absolute z-50'>
            <img loading='lazy' className='w-full h-full object-cover' src="./src/assets/img/nhận.png" />
          </div>
          <div className='1.000 w-[128px] md:w-[285px] bg-cover absolute z-30 -left-[196px] top-[34px] md:-left-[488px] md:-top-[15px] '>
            <img loading='lazy' className='w-full h-full object-cover' src="./src/assets/img/1.000.png" />
          </div>
          <div className='40.000 w-[183px] md:w-[410px] bg-cover absolute -left-[90px] top-[70px] md:-left-[250px] md:top-[65px] z-40'>
            <img loading='lazy' className='w-full h-full object-cover' src="./src/assets/img/40.000.png" />
          </div>
          <div className='60.000 w-[193px] md:w-[433px] bg-cover absolute top-[70px] -right-[138px] md:-right-[325px] md:top-[65px] z-40 '>
            <img loading='lazy' className='w-full h-full object-cover' src="./src/assets/img/60.000.png" />
          </div>
          <div className='20.000 w-[115px] md:w-[258px] bg-cover absolute -right-[239px] top-[34px] md:-right-[554px] md:-top-[15px] z-30'>
