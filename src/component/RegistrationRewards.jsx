    ...
    <div className={`relative`}>
      <div >
        <div className='anchor w-[574px] h-[588px] absolute left-1/2 -translate-x-1/2'>
          ...
          <div className='40.000 w-[410px] h-[372px] bg-cover absolute  -left-[250px] top-[65px] z-40'>
            <img loading='lazy' className='w-full h-full object-cover' src="./src/assets/img/40.000.png" />
          </div>
          <div className='60.000 w-[433px] h-[418px] bg-cover absolute -right-[325px] top-[65px] z-40 '>
